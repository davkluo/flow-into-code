  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 px-6 py-8">
      ...
      <div className="space-y-8">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold tracking-tight text-foreground">Why I Built Flow Into Code</h2>
          <p className="text-foreground/90 text-sm leading-6">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold tracking-tight text-foreground">A Consistent Process</h2>
          <p className="text-foreground/90 text-sm leading-6">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold tracking-tight text-foreground">Reframing LeetCode Practice</h2>
          <p className="text-foreground/90 text-sm leading-6">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold tracking-tight text-foreground">Why LeetCode Still Matters in 2026</h2>
          <p className="text-foreground/90 text-sm leading-6">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold tracking-tight text-foreground">Code Execution</h2>
          <p className="text-foreground/90 text-sm leading-6">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold tracking-tight text-foreground">Free. Forever.</h2>
          <p className="text-foreground/90 text-sm leading-6">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold tracking-tight text-foreground">Open Source</h2>
          <p className="text-foreground/90 text-sm leading-6">
